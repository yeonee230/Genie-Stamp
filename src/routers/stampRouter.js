...
import { rankingThisMonthStamps, rankingTotalStamps } from '../controllers/stampController';
...
stampRouter.get('/ranking/:month', protectMiddeleware, rankingThisMonthStamps); // 월별 누적 도장 랭킹
